...
public class AoASimpleGrinderObject extends CraftingStationObject {
    public GameTexture texture;

    public AoASimpleGrinderObject() {
        super(new Rectangle(32, 32));
        this.mapColor = new Color(166, 166, 166);
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoasimplegrinderobject");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{ RecipeTechRegistry.getTech("aoasimplegrinder")};
    }
}
