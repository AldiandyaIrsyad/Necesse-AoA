...
public class AoATier4ProcessingForgeObject extends GameObject implements SettlementWorkstationObject {
    public GameTexture texture;

    public AoATier4ProcessingForgeObject() {
    ...
    public int getLightLevel(Level level, int x, int y) {
        AoATier4ProcessingForgeObjectEntity forgeObjectEntity = this.getForgeObjectEntity(level, x, y);
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoafusionforge");
    }
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        AoATier4ProcessingForgeObjectEntity objectEntity = this.getForgeObjectEntity(level, tileX, tileY);
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new AoATier4ProcessingForgeObjectEntity(level, x, y);
    }
    ...
    public AoATier4ProcessingForgeObjectEntity getForgeObjectEntity(Level level, int tileX, int tileY) {
        ObjectEntity objectEntity = level.entityManager.getObjectEntity(tileX, tileY);
        return objectEntity instanceof AoATier4ProcessingForgeObjectEntity ? (AoATier4ProcessingForgeObjectEntity)objectEntity : null;
    }

    public Stream<Recipe> streamSettlementRecipes(Level level, int tileX, int tileY) {
        AoATier4ProcessingForgeObjectEntity forgeObjectEntity = this.getForgeObjectEntity(level, tileX, tileY);
