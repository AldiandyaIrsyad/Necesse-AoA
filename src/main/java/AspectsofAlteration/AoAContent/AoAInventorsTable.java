...
public class AoAInventorsTable extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoAInventorsTable() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoainventorstable");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoainventorstable")};
    }

    public static int[] registerInventorsTable() {
        AoAInventorsTable cb1o = new AoAInventorsTable();
        AoAInventorsTable2 cb2o = new AoAInventorsTable2();
        int aoait1 = ObjectRegistry.registerObject("aoainventorstable", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoainventorstable2", cb2o, 0.0F, false);
