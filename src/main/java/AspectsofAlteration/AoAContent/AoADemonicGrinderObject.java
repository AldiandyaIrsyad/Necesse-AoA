...
public class AoADemonicGrinderObject extends CraftingStationObject {
    public GameTexture texture;

    public AoADemonicGrinderObject() {
        super(new Rectangle(32, 32));
        this.mapColor = new Color(121, 70, 150);
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoademonicgrinderobject");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoademonicgrinder"),
