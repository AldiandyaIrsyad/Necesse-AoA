...
public class AoAFlameBladeProjectile extends Projectile {
    public AoAFlameBladeProjectile() {
    }

    public AoAFlameBladeProjectile(float x, float y, float angle, float speed, int distance, GameDamage damage, Mob owner) {
        this.x = x;
        this.y = y;
        this.setAngle(angle);
        this.speed = 100;
    ...
    public Trail getTrail() {
        return new Trail(this, this.getLevel(), new Color(122, 64, 17), 40.0F, 500, 16.0F);
    }
