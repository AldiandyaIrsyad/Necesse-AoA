...
public class AoAIndustrialGrinderObject extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    public AoAIndustrialGrinderObject() {
    ...
    public static int[] registerIndustrialGrinderObject() {
        AoAIndustrialGrinderObject o1 = new AoAIndustrialGrinderObject();
        AoAIndustrialGrinderObject2 o2 = new AoAIndustrialGrinderObject2();
        int i1 = ObjectRegistry.registerObject("aoaindustrialgrinderobject", o1, 140.0F, true);
        int i2 = ObjectRegistry.registerObject("aoaindustrialgrinderobject2", o2, 0.0F, false);
        o1.counterID = i2;
        o2.counterID = i1;
