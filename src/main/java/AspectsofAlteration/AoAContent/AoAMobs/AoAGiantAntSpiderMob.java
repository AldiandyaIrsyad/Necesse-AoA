...
public class AoAGiantAntSpiderMob extends HostileMob {
    ...
    public static LootTable lootTable = new LootTable(
            ChanceLootItem.between(0.5f, "aoaantplatescale", 1, 3) // 50% chance to drop between 1-3 example items
    );

    // MUST HAVE an empty constructor
    public AoAGiantAntSpiderMob() {
        super(250);
        setSpeed(37);
        setFriction(3);
        setArmor(7);
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 500, new GameDamage(25), 25, 120));
    }
