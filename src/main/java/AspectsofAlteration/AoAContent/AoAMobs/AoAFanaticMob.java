...
public class AoAFanaticMob extends HostileMob {

    public static GameTexture texture;

    public static LootTable lootTable = new LootTable(
            ChanceLootItem.between(0.5f, "aoamalachitekey", 1, 3)
    );

    public AoAFanaticMob() {
        super(1500);
        setSpeed(35);
        setFriction(3);
        setArmor(35);
    ...
    public void init() {
        super.init();
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 100, new GameDamage(56), 75, 4000));
    }
