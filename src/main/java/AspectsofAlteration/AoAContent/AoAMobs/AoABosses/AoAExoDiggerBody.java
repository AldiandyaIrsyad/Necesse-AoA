...
public class AoAExoDiggerBody extends BossWormMobBody<AoAExoDiggerHead, AoAExoDiggerBody> {
    ...
    public GameMessage getLocalization() {
        return new LocalMessage("mob", "aoagiantseaserpentmob");
    }

    public GameDamage getCollisionDamage(Mob target) {
        return AoAExoDiggerHead.bodyCollisionDamage;
    }
    ...
    protected void addDrawables(List<MobDrawable> list, OrderableDrawables tileList, OrderableDrawables topList, Level level, int x, int y, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        if (this.isVisible()) {
            ...
            WormMobHead.addDrawable(list, new GameSprite(MobRegistry.Textures.fromFile("aoaexodigger"), this.sprite.x, this.sprite.y, 96), MobRegistry.Textures.swampGuardian_mask, light, (int)this.height, drawX, drawY, 64);
