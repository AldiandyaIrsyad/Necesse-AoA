...
public class AoALordofAether extends FlyingBossMob {
    ...
    public AoALordofAether() {
        ...
        this.magicSoundAbility = (EmptyMobAbility)this.registerAbility(new EmptyMobAbility() {
            protected void run() {
                if (AoALordofAether.this.isClient()) {
                    Screen.playSound(GameResources.magicbolt1, SoundEffect.effect(AoALordofAether.this));
                }
        ...
        this.jingleSoundAbility = (EmptyMobAbility)this.registerAbility(new EmptyMobAbility() {
            protected void run() {
                if (AoALordofAether.this.isClient()) {
                    ...
                    Screen.playSound(GameResources.fadedeath3, SoundEffect.effect(AoALordofAether.this).pitch(pitch));
                }
        ...
        this.attackingAnimationAbility = (BooleanMobAbility)this.registerAbility(new BooleanMobAbility() {
            protected void run(boolean value) {
                AoALordofAether.this.attackingAnimation = value;
            }
        });
    }
    ...
    public void init() {
        super.init();
        this.ai = new BehaviourTreeAI(this, new AoALordofAether.CryoQueenAI(), new FlyingAIMover());
        if (this.isClient()) {
    ...
    public static class CryoVolleyRotation3<T extends AoALordofAether> extends RunningAINode<T> {
        private int ticker;
            ...
            GameUtils.streamServerClients(mob.getLevel()).map((c) -> {
                ...
                if (firedAngles.stream().noneMatch((f) -> {
                    ...
                    for(int i = 0; i < missiles; ++i) {
                        ...
                        mob.getLevel().entityManager.projectiles.add(new AoABossAttackWaveProjectile((float)mob.x, (float)mob.y, angleToTarget -20F, (float)2000, (int)2000, AoALordofAether.collisionDamage, mob));
                        mob.getLevel().entityManager.projectiles.add(new AoABossAttackWaveProjectile((float)mob.x, (float)mob.y, angleToTarget -10F, (float)2000, (int)2000, AoALordofAether.collisionDamage, mob));
                        mob.getLevel().entityManager.projectiles.add(new AoABossAttackWaveProjectile((float)mob.x, (float)mob.y, angleToTarget , (float)2000, (int)2000, AoALordofAether.collisionDamage, mob));
                        mob.getLevel().entityManager.projectiles.add(new AoABossAttackWaveProjectile((float)mob.x, (float)mob.y, angleToTarget + 10F, (float)2000, (int)2000, AoALordofAether.collisionDamage, mob));
                        mob.getLevel().entityManager.projectiles.add(new AoABossAttackWaveProjectile((float)mob.x, (float)mob.y, angleToTarget + 20F, (float)2000, (int)2000, AoALordofAether.collisionDamage, mob));
                    }
    ...
    public static class CryoVolleyRotation<T extends AoALordofAether> extends RunningAINode<T> {
        private int ticker;
            ...
            GameUtils.streamServerClients(mob.getLevel()).map((c) -> {
                ...
                if (firedAngles.stream().noneMatch((f) -> {
                    ...
                    for(int i = 0; i < missiles; ++i) {
                        ...
                        Point2D.Float targetPos = new Point2D.Float(target.x + (float)GameRandom.globalRandom.getIntBetween(-50, 50), target.y + (float)GameRandom.globalRandom.getIntBetween(-50, 50));
                        float var10003 = mob.x + offset.x;
                        mob.getLevel().entityManager.projectiles.add(new AoAChaoticWave(mob.getLevel(), mob.x, mob.y, (float)targetPos.x, (float)targetPos.y, 200, 2000, AoALordofAether.collisionDamage, mob));
                    }
    ...
    public static class CryoVolleyRotation2<T extends AoALordofAether> extends RunningAINode<T> {
        private int ticker;
            ...
            GameUtils.streamServerClients(mob.getLevel()).map((c) -> {
                ...
                if (firedAngles.stream().noneMatch((f) -> {
                    ...
                    for(int i = 0; i < missiles; ++i) {
                        ...
                        Point2D.Float targetPos = new Point2D.Float(target.x + (float)GameRandom.globalRandom.getIntBetween(-50, 50), target.y + (float)GameRandom.globalRandom.getIntBetween(-50, 50));
                        float var10003 = mob.x + offset.x;
                        mob.getLevel().entityManager.addLevelEvent(new AoAChaoticBombAttackEvent(mob,(int)target.x + GameRandom.globalRandom.getIntBetween(-300,300), (int)target.y + GameRandom.globalRandom.getIntBetween(-300,300), GameRandom.globalRandom, AoALordofAether.collisionDamage));
                    }
    ...
    public static class CryoShardRotation<T extends AoALordofAether> extends RunningAINode<T> {
        private int ticker;
    ...
    public static class CryoShardRotation2<T extends AoALordofAether> extends RunningAINode<T> {
        private int ticker;
        private int timerBuffer;
        private boolean reversed;
    ...
    public static class CryoQueenAI<T extends AoALordofAether> extends SequenceAINode<T> {
        public CryoQueenAI() {
            ...
            rotations.addChild(new AoALordofAether.CryoShardRotation2());
            rotations.addChild(new AoALordofAether.IdleTime(2000));
            rotations.addChild(new AoALordofAether.CryoVolleyRotation3());
            rotations.addChild(new AoALordofAether.IdleTime(700));
            rotations.addChild(new AoALordofAether.MoveToRandomPosition(true, 300));
            rotations.addChild(new AoALordofAether.IdleTime(100));
            rotations.addChild(new AoALordofAether.CryoShardRotation());
            rotations.addChild(new AoALordofAether.IdleTime(700));
            rotations.addChild(new AoALordofAether.CryoVolleyRotation3());
            rotations.addChild(new AoALordofAether.IdleTime(700));
            rotations.addChild(new AoALordofAether.MoveToRandomPosition(true, 100));
            rotations.addChild(new AoALordofAether.CryoVolleyRotation());
            rotations.addChild(new AoALordofAether.IdleTime(100));
            rotations.addChild(new AoALordofAether.CryoShardRotation2());
            rotations.addChild(new AoALordofAether.IdleTime(2000));
            rotations.addChild(new AoALordofAether.MoveToRandomPosition(true, 300));
            ...
            for(int i = 0; i < 5; ++i) {
                rotations.addChild(new AoALordofAether.MoveToRandomPosition(false, 100));
                rotations.addChild(new AoALordofAether.IdleTime(100));
                rotations.addChild(new AoALordofAether.CryoVolleyRotation2());
            }
