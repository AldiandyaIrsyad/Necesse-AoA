...
public class AoASwordGolemMob extends HostileMob {
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 500, new GameDamage(110), 25, 40000));
    }
