...
public class AoAArmoredSwordGolemMob extends HostileMob {

    public static GameTexture texture;

    public static LootTable lootTable = new LootTable(
            ChanceLootItem.between(0.1f, "aoawolfcallerstaffsummontoolitem", 1, 1),
            ChanceLootItem.between(0.9f, "bone", 5, 16),
            ChanceLootItem.between(0.9f, "aoahauntedremainsmaterialitem", 1, 10)
    );

    // MUST HAVE an empty constructor
    public AoAArmoredSwordGolemMob() {
        super(250);
        setSpeed(25);
        setFriction(3);
        setArmor(13);
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 500, new GameDamage(140), 25, 40000));
    }
