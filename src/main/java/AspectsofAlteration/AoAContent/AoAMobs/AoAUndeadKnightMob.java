...
public class AoAUndeadKnightMob extends HostileMob {
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 500, new GameDamage(56), 25, 50));
    }
