...
public class AoAUndeadWarriorMob extends HostileMob {

    public static GameTexture texture;

    public static LootTable lootTable = new LootTable(
            ChanceLootItem.between(0.05f, "aoafrostbornspear", 1, 1),
            ChanceLootItem.between(0.05f, "aoaspiritbottletrinket", 1, 1),
            ChanceLootItem.between(0.8f, "bone", 1, 6),
            ChanceLootItem.between(0.5f, "aoahauntedremains", 1, 10)
    );

    // MUST HAVE an empty constructor
    public AoAUndeadWarriorMob() {
        super(500);
        setSpeed(37);
        setFriction(3);
        setArmor(7);
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 500, new GameDamage(75), 25, 50));
    }
