...
public class AoAFrostbornChampion extends HostileMob {
    ...
    public void init() {
        super.init();
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 500, new GameDamage(56), 75, 4000));
    }
