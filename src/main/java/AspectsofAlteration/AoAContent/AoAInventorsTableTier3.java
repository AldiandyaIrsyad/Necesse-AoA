...
public class AoAInventorsTableTier3 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoAInventorsTableTier3() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoainventorstabletier3");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoainventorstable"),RecipeTechRegistry.getTech("aoainventorstabletier2"),RecipeTechRegistry.getTech("aoainventorstabletier3")};
    }

    public static int[] registerInventorsTable() {
        AoAInventorsTableTier3 cb1o = new AoAInventorsTableTier3();
        AoAInventorsTableTier3_2 cb2o = new AoAInventorsTableTier3_2();
        int aoait1 = ObjectRegistry.registerObject("aoainventorstabletier3", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoainventorstabletier3_2", cb2o, 0.0F, false);
