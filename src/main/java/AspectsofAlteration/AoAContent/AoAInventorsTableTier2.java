...
public class AoAInventorsTableTier2 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoAInventorsTableTier2() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoainventorstabletier2");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoainventorstable"),RecipeTechRegistry.getTech("aoainventorstabletier2")};
    }

    public static int[] registerInventorsTable() {
        AoAInventorsTableTier2 cb1o = new AoAInventorsTableTier2();
        AoAInventorsTableTier2_2 cb2o = new AoAInventorsTableTier2_2();
        int aoait1 = ObjectRegistry.registerObject("aoainventorstabletier2", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoainventorstabletier2_2", cb2o, 0.0F, false);
