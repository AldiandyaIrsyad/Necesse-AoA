...
public class AoACrystalCluster extends GameObject {

    private GameTexture texture;

    public AoACrystalCluster() {
        ...
        mapColor = new Color(0, 255, 234); // Also applies as debris color if not set
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/aoacrystalcluster");
    }
