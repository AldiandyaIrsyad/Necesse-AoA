...
public class AoASmithyTier1 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoASmithyTier1() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoasmithytier1");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoasmithytier1")};
    }

    public static int[] registerSmithyTier1() {
        AoASmithyTier1 cb1o = new AoASmithyTier1();
        AoASmithyTier1_2 cb2o = new AoASmithyTier1_2();
        int aoait1 = ObjectRegistry.registerObject("aoasmithytier1", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoasmithytier1_2", cb2o, 0.0F, false);
