...
public class AoASerpentSpawnitem extends ConsumableItem {
    public AoASerpentSpawnitem() {
        super(1, true);
    ...
    public InventoryItem onPlace(Level level, int x, int y, PlayerMob player, InventoryItem item, PacketReader contentReader) {
        if (level.isServerLevel()) {
            System.out.println("Giant sea serpent has been summoned at " + level.getIdentifier() + ".");
            ...
            Mob mob = MobRegistry.getMob("aoagiantserpenthead", level);
