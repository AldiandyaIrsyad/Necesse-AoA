...
public class AoAInventorsTableTier6 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoAInventorsTableTier6() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoainventorstabletier6");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoainventorstable"),RecipeTechRegistry.getTech("aoainventorstabletier2"),RecipeTechRegistry.getTech("aoainventorstabletier3"),RecipeTechRegistry.getTech("aoainventorstabletier4"),RecipeTechRegistry.getTech("aoainventorstabletier5"),RecipeTechRegistry.getTech("aoainventorstabletier6")};
    }

    public static int[] registerInventorsTable() {
        AoAInventorsTableTier6 cb1o = new AoAInventorsTableTier6();
        AoAInventorsTableTier6_2 cb2o = new AoAInventorsTableTier6_2();
        int aoait1 = ObjectRegistry.registerObject("aoainventorstabletier6", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoainventorstabletier6_2", cb2o, 0.0F, false);
