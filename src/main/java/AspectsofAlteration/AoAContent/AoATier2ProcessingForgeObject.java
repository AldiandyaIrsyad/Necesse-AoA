...
public class AoATier2ProcessingForgeObject extends GameObject implements SettlementWorkstationObject {
    public GameTexture texture;

    public AoATier2ProcessingForgeObject() {
    ...
    public int getLightLevel(Level level, int x, int y) {
        AoATier2ProcessingForgeObjectEntity forgeObjectEntity = this.getForgeObjectEntity(level, x, y);
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoadeepstoneforge");
    }
    ...
    public void addDrawables(List<LevelSortedDrawable> list, OrderableDrawables tileList, Level level, int tileX, int tileY, TickManager tickManager, GameCamera camera, PlayerMob perspective) {
        ...
        AoATier2ProcessingForgeObjectEntity objectEntity = this.getForgeObjectEntity(level, tileX, tileY);
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new AoATier2ProcessingForgeObjectEntity(level, x, y);
    }
    ...
    public AoATier2ProcessingForgeObjectEntity getForgeObjectEntity(Level level, int tileX, int tileY) {
        ObjectEntity objectEntity = level.entityManager.getObjectEntity(tileX, tileY);
        return objectEntity instanceof AoATier2ProcessingForgeObjectEntity ? (AoATier2ProcessingForgeObjectEntity)objectEntity : null;
    }

    public Stream<Recipe> streamSettlementRecipes(Level level, int tileX, int tileY) {
        AoATier2ProcessingForgeObjectEntity forgeObjectEntity = this.getForgeObjectEntity(level, tileX, tileY);
