...
public class AoABarrelStackObject extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    public AoABarrelStackObject() {
    ...
    public static int[] registerBarrelStackObject() {
        AoABarrelStackObject o1 = new AoABarrelStackObject();
        AoABarrelStackObject2 o2 = new AoABarrelStackObject2();
        int i1 = ObjectRegistry.registerObject("aoabarrelstackobject", o1, 140.0F, true);
        int i2 = ObjectRegistry.registerObject("aoabarrelstackobject2", o2, 0.0F, false);
        o1.counterID = i2;
        o2.counterID = i1;
