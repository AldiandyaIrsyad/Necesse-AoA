...
public class AoASmithyTier3 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoASmithyTier3() {
    ...
    public static int[] registerSmithyTier3() {
        AoASmithyTier3 cb1o = new AoASmithyTier3();
        AoASmithyTier3_2 cb2o = new AoASmithyTier3_2();
        int aoait1 = ObjectRegistry.registerObject("aoasmithytier3", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoasmithytier3_2", cb2o, 0.0F, false);
