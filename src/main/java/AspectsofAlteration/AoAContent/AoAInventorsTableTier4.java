...
public class AoAInventorsTableTier4 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoAInventorsTableTier4() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoainventorstabletier4");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoainventorstable"),RecipeTechRegistry.getTech("aoainventorstabletier2"),RecipeTechRegistry.getTech("aoainventorstabletier3"),RecipeTechRegistry.getTech("aoainventorstabletier4")};
    }

    public static int[] registerInventorsTable() {
        AoAInventorsTableTier4 cb1o = new AoAInventorsTableTier4();
        AoAInventorsTableTier4_2 cb2o = new AoAInventorsTableTier4_2();
        int aoait1 = ObjectRegistry.registerObject("aoainventorstabletier4", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoainventorstabletier4_2", cb2o, 0.0F, false);
