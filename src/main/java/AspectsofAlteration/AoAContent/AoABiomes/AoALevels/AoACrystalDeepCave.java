...
public class AoACrystalDeepCave extends ForestDeepCaveLevel {
    public AoACrystalDeepCave(LevelIdentifier identifier, int width, int height, WorldEntity worldEntity) {
        super(identifier, width, height, worldEntity);
    }

    public AoACrystalDeepCave(int islandX, int islandY, int dimension, WorldEntity worldEntity) {
