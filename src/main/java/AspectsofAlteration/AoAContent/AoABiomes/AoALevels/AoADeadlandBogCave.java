...
public class AoADeadlandBogCave extends SwampSurfaceLevel {
    public AoADeadlandBogCave(LevelIdentifier identifier, int width, int height, WorldEntity worldEntity) {
        super(identifier, width, height, worldEntity);
    }

    public AoADeadlandBogCave(int islandX, int islandY, int dimension, WorldEntity worldEntity) {
    ...
    public void generateLevel() {
        ...
        GameEvents.triggerEvent(new GenerateCaveOresEvent(this, cg), (e) -> {
            cg.generateOreVeins(0.3F, 3, 6, ObjectRegistry.getObjectID("aoadeadlandbogrockiron"));
            cg.generateOreVeins(0.3F, 3, 6, ObjectRegistry.getObjectID("aoadeadlandbogrocklifequartz"));
            cg.generateOreVeins(0.25F, 3, 6, ObjectRegistry.getObjectID("aoadeadlandbogrocktungsten"));
