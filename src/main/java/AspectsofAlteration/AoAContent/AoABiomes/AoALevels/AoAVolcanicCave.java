...
public class AoAVolcanicCave extends DesertSurfaceLevel {
    public AoAVolcanicCave(LevelIdentifier identifier, int width, int height, WorldEntity worldEntity) {
        super(identifier, width, height, worldEntity);
    }

    public AoAVolcanicCave(int islandX, int islandY, int dimension, WorldEntity worldEntity) {
    ...
    public void generateLevel() {
        ...
        GameEvents.triggerEvent(new GenerateCaveMiniBiomesEvent(this, cg), (e) -> {
            ...
            cg.generateRandomSingleRocks(ObjectRegistry.getObjectID("caverock"), 0.015F);
            cg.generateRandomSingleRocks(ObjectRegistry.getObjectID("caverocksmall"), 0.02F);
        });
        ...
        GameEvents.triggerEvent(new GenerateCaveOresEvent(this, cg), (e) -> {
            cg.generateOreVeins(0.3F, 3, 10, ObjectRegistry.getObjectID("aoamineralchunkorebasalt"));
            cg.generateOreVeins(0.3F, 7, 20, ObjectRegistry.getObjectID("aoaironbasalt"));
            cg.generateOreVeins(0.3F, 7, 20, ObjectRegistry.getObjectID("aoacopperbasalt"));
            cg.generateOreVeins(0.25F, 7, 20, ObjectRegistry.getObjectID("aoagoldbasalt"));
        });
