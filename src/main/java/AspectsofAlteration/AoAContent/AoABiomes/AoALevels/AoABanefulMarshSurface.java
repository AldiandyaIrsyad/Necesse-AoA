...
public class AoABanefulMarshSurface extends Level {
    public AoABanefulMarshSurface(LevelIdentifier identifier, int width, int height, WorldEntity worldEntity) {
        super(identifier, width, height, worldEntity);
    }

    public AoABanefulMarshSurface(int islandX, int islandY, float islandSize, Server server, WorldEntity worldEntity) {
    ...
    public void generateLevel(float islandSize) {
        ...
        int sandTile = TileRegistry.getTileID("aoavenommudtile");
        int grassTile = TileRegistry.getTileID("aoavenomstonetile");
        ...
        GameEvents.triggerEvent(new GenerateIslandFloraEvent(this, islandSize, ig), (e) -> {
            int oakTree = ObjectRegistry.getObjectID("aoaaurumarboristree");
            int spruceTree = ObjectRegistry.getObjectID("aoaaurumarboristree");
            int grassObject = ObjectRegistry.getObjectID("aoaalpinegrassobject");
            int bush = ObjectRegistry.getObjectID("aoavenomstalk");
            int shrubbush = ObjectRegistry.getObjectID("aoavenomstalk");
            ...
            ig.generateCellMapObjects(0.05F, shrubbush, grassTile, 0.28F);
            ig.generateCellMapObjects(0.05F, bush, grassTile, 0.32F);
