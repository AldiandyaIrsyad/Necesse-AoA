...
public class AoATier1Extractor extends GameObject implements SettlementWorkstationObject {
    public GameTexture texture;
    public GameTexture onTexture;

    public AoATier1Extractor() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoaextractortier1");

        try {
            this.onTexture = GameTexture.fromFileRaw("objects/aoaextractortier1_open");
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new AoATier1ExtractorObjectEntity(level, x, y);
    }
