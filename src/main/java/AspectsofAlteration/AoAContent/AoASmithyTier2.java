...
public class AoASmithyTier2 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoASmithyTier2() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoasmithytier2");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoasmithytier1"),RecipeTechRegistry.getTech("aoasmithytier2")};
    }

    public static int[] registerSmithyTier2() {
        AoASmithyTier2 cb1o = new AoASmithyTier2();
        AoASmithyTier2_2 cb2o = new AoASmithyTier2_2();
        int aoait1 = ObjectRegistry.registerObject("aoasmithytier2", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoasmithytier2_2", cb2o, 0.0F, false);
