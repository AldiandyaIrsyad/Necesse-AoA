...
public class AoAInventorsTableTier5 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoAInventorsTableTier5() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoainventorstabletier5");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoainventorstable"),RecipeTechRegistry.getTech("aoainventorstabletier2"),RecipeTechRegistry.getTech("aoainventorstabletier3"),RecipeTechRegistry.getTech("aoainventorstabletier4"),RecipeTechRegistry.getTech("aoainventorstabletier5")};
    }

    public static int[] registerInventorsTable() {
        AoAInventorsTableTier5 cb1o = new AoAInventorsTableTier5();
        AoAInventorsTableTier5_2 cb2o = new AoAInventorsTableTier5_2();
        int aoait1 = ObjectRegistry.registerObject("aoainventorstabletier5", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoainventorstabletier5_2", cb2o, 0.0F, false);
