...
public class AoAIgnusClusterSmall extends GameObject {

    private GameTexture texture;

    public AoAIgnusClusterSmall() {
        ...
        mapColor = new Color(255, 68, 0); // Also applies as debris color if not set
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/aoaignusclustersmall");
    }
