...
public class AoAAlpineShrubObject extends GameObject {
    ...
    public void loadTextures() {
        super.loadTextures();
        texture = GameTexture.fromFile("objects/aoaalpineshrubobject");
    }
