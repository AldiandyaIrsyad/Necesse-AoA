...
public class AoASpiderAntEggCluster extends GameObject {
    private GameTexture texture;
    private GameTexture brokenTexture;

    public AoASpiderAntEggCluster() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoaantspidereggcluster");
        this.brokenTexture = GameTexture.fromFile("objects/aoaantspidereggcluster_broken");
    }
