...
public class AoARootResinPlant extends GrassObject {
    public static double spreadChance = GameMath.getAverageSuccessRuns(300.0);

    public AoARootResinPlant() {
        super("aoaresinroot", -1);
        this.canPlaceOnShore = true;
        this.mapColor = new Color(161, 147, 93);
    ...
    public GameMessage getNewLocalization() {
        return new LocalMessage("object", "aoaresinroot");
    }
