...
public class AoAAurumArborisTree extends GameObject implements ForestryJobObject {
    ...
    public AoAAurumArborisTree(String textureName, String logStringID, String saplingStringID, Color mapColor, int leavesCenterWidth, int leavesMinHeight, int leavesMaxHeight, String leavesTextureName) {
    ...
    public LootTable getLootTable(Level level, int tileX, int tileY) {
        LootTable lootTable = new LootTable(new LootItemInterface[]{
                LootItem.between("aoaaurumarborisleaf", 40, 100)
        });
