...
public class AoASmithyTier4 extends CraftingStationObject {
    public GameTexture texture;
    protected int counterID;

    private AoASmithyTier4() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/aoasmithytier4");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("aoasmithytier1"),RecipeTechRegistry.getTech("aoasmithytier2"),RecipeTechRegistry.getTech("aoasmithytier3"),RecipeTechRegistry.getTech("aoasmithytier4")};
    }

    public static int[] registerSmithyTier4() {
        AoASmithyTier4 cb1o = new AoASmithyTier4();
        AoASmithyTier4_2 cb2o = new AoASmithyTier4_2();
        int aoait1 = ObjectRegistry.registerObject("aoasmithytier4", cb1o, 20.0F, true);
        int aoait2 = ObjectRegistry.registerObject("aoasmithytier4_2", cb2o, 0.0F, false);
