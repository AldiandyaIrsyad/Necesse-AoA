...
public class AoATier1ExtractorObjectEntity extends ProcessingTechInventoryObjectEntity {
    public AoATier1ExtractorObjectEntity(Level level, int x, int y) {
        super(level, "cheesepress", x, y, 2, 2, new Tech[]{RecipeTechRegistry.getTech("aoatier1extractor")});
    }
